...
% - Estudio teórico: 2 meses, 2 horas a la semana
% - Estudio de librerías/herramientas: 1 mes, dos horas a la semana
% - Implementación: Mes con 6 horas al día

\subsection{Coste de despliegue}

% \ref{appendix:server-do}

Para la ejecución del servidor de TFHE hemos contratado una máquina en DigitalOcean (\url{https://www.digitalocean.com/}) durante una semana. Comenzamos 

Máquina digital ocean con cálculo (tiempo*precio): Datos de facturación + Pantallazos
