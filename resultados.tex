...
\begin{table}[]
    \centering
    \begin{tabular}{r | c c c c}
        Cálculo & Tiempo,estimado & Tiempo,real & Proporción \\
        \hline \hline
...
% Resultados de regresión cuadrática
...
% Es la operación más costosa. Va en función del número de valores introducidos, mientras que el resto siempre tardarán lo mismo (con el mismo número de bits)
% /*
%   multi = 5
%   suma = 7
%
