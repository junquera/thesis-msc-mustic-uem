...
\begin{itemize}
    ...
    \begin{table}
        ...
        \begin{subtable}
            ...
            \end{tabular}
      \end{subtable}
       \caption{Relación entre \textit{poly\_modulus\_degree} y y el número de bits de \textit{coeff\_modulus\_degree}}
...
% Los elementos que forman TFHE son mucho menos complejos que los de SEAL, con un único sistema de cifrado \url{http://lab.algonics.net/slides_ac16/index-asiacrypt.html}.
