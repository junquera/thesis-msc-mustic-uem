...
Todas estas operaciones se pueden aplicar para operar los elementos cifrados tanto con otros elementos cifrados como con números en texto plano (codificados).
