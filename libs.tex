...
\begin{gather}
    \begin{bmatrix}
        c_11    & c_12  & \hdots    & c_1n \\
        c_21    & c_22  & \hdots    & c_2n 
    \end{bmatrix}
    =
    \begin{bmatrix}
        a_11    & a_12  & \hdots    & a_1n \\
        a_21    & a_22  & \hdots    & a_2n
    \end{bmatrix}
    *
    \begin{bmatrix}
        b_11    & b_12  & \hdots    & b_1n \\
        b_21    & b_22  & \hdots    & b_2n
    \end{bmatrix}
    =
    \begin{bmatrix}
        (a_11 * b_11)    & (a_12 * b_12)  & \hdots    & (a_1n * b_1n) \\
        (a_21 * b_21)    & (a_22 * b_22)  & \hdots    & (a_2n * b_2n)
    \end{bmatrix}
\end{gather}
